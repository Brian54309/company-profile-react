        ...
        <div className="collapse navbar-collapse" id="navbarToggler">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0 justify-content-around w-100">
            <li className="nav-item text-light">
              <a href="#home" className="nav-link text-white mx-5" aria-current="page">
                Home
              </a>
            </li>
            <li className="nav-item">
              <a href="#about" className="nav-link text-white mx-5">
                About Us
              </a>
            </li>
            <li className="nav-item dropdown">
              <a href="#product" className="nav-link text-white mx-5 dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                Product
              </a>
              <ul className="dropdown-menu">
                <li><Link to='/broco'className="dropdown-item">Broco</Link></li>
                <li><Link className="dropdown-item">Panasonic</Link></li>
              </ul>
            </li>
            <li className="nav-item">
